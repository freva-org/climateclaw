...
from climateclaw.services.streaming.stream_variants import StreamVariant
...
def get_mongodb_uri() -> str:
    user = os.getenv("CLIMATECLAW_MONGODB_USER", "")
    password = os.getenv("CLIMATECLAW_MONGODB_PASSWORD", "")
