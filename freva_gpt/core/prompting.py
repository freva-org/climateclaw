...
from freva_gpt.core.available_chatbots import model_is_gpt_5, model_is_ollama
...
BASELINE_DIRS = [
    Path("freva_gpt/prompt_library/baseline"),
]

GPT5_DIRS = [
    Path("freva_gpt/prompt_library/gpt_5"),
]

OLLAMA_DIRS = [
    Path("freva_gpt/prompt_library/ollama"),
]
